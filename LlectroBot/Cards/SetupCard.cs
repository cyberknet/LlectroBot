...
namespace LlectroBot.Cards.LelectroBotCards
{
    ...
    {
        private LlectroBotCardContext LlectroBotContext { get { return Context as LlectroBotCardContext; } }
        ...
        public override async Task<CardResult> MessageReceived(IMessage message)
        {
